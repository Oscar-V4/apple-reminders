...
_RUNTIME_SCHEMA_REQUIREMENTS: SchemaProfile = {
    "early_reminder_native": _schema(
        ZREMCDREMINDER="ZCKIDENTIFIER Z_OPT ZLIST ZMARKEDFORDELETION ZDUEDATEDELTAALERTSDATA",
        ZREMCDDUEDATEDELTAALERT="ZIDENTIFIER ZREMINDERIDENTIFIER ZDUEDATEDELTACOUNT ZDUEDATEDELTAUNIT Z_OPT Z_PK",
    ),
