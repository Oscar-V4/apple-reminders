...
3. If asked to create a list, use `ensure_reminder_list` with exact `source_id`, exact name, and a fresh idempotency key. Public 0.3 does not set color or emblem.
