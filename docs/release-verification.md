...
For the v0.7.0 Unreleased candidate, matching new EventKit and Native artifacts
remain pending until recorded in the [signoff record](release-evidence/release-candidate-signoff.md).
