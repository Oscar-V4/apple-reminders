...
- Local reverse-engineering has proven that reminders, lists, sections, tags, URL attachments, image attachments, dates, flags, and priorities can be manipulated without foreground UI gestures.
